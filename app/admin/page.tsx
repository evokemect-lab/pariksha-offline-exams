...
type Tab = "exams" | "centers" | "tickets" | "results" | "papers";
          ...
          {tab === "centers" && (
            <div className="space-y-4">
              <div className="card space-y-2">
                ...
                <button onClick={() => { act("create-center", { name: cName, center_code: cCode, address: cAddr, city: cCity, capacity: Number(cCap), contact_phone: cPhone }); setCName(""); setCCode(""); setCAddr(""); setCCity(""); setCPhone(""); }} className="btn" disabled={busy || !cName || !cCity}>Add center</button>
              </div>
              <div className="card space-y-2">
