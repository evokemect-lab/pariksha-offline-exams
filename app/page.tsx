    ...
    <main className="mt-8 space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <div className="card">
          ...
          <p className="text-sm text-slate-400">Pick exam + center. Free registration for now.</p>
        </div>
        <div className="card">
          <div className="text-2xl">🎫</div>
          <h3 className="mt-2 font-bold">2. Hall ticket</h3>
          <p className="text-sm text-slate-400">Get hall ticket no. + room/seat + QR. Print and bring with ID.</p>
        </div>
        <div className="card">
          <div className="text-2xl">🏫</div>
          <h3 className="mt-2 font-bold">3. Attend offline</h3>
          <p className="text-sm text-slate-400">Invigilator scans QR at gate. Attendance + results tracked here.</p>
        </div>
      </div>

      <div className="card">
        <h2 className="font-bold">For staff / invigilators</h2>
        <p className="text-sm text-slate-400">Use Verify page to scan QR or enter hall ticket no. and mark attendance.</p>
